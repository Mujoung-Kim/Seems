...
class JosaExtractor() :
	...
	def __init__(self, text: str, result_set: set) :
		...
		self.josa_set = [ "고", "하고", "부터", "와", "에게", "로써", "를", "은", "라고", "이랑", "이", "에서", "으로", "이다", "의", "가", "을", "까지", "로서", "서", "나", "께서", "이며", "에", "라", "과", "는", "조차", "랑", "도", "야말로", "보다", "로", "에다", "야", "마저", "이라고", "하며", "한다", "면", "해", "이었다", "였다", "했다" ]
	...
	def _set(self, result_set: set) :
		...
		for eojeol in eojeols :
			...
			if len(eojeol) == 1 or str(eojeol).isdigit() :
				continue
